...
class EpisodeHistory:
    ...
    def create_plot(self):
        ...
        self.ax.set_title("Learning curve with L2 loss")
        self.ax.set_xlabel("Number of Games")
        self.ax.set_ylabel("Cumulative Average Score")
...
def run_agent(env, verbose=False):
    ...
    goal_avg_episode_length = 1000
    goal_consecutive_episodes = 100

    plot_episode_count = 1000
...
def main():
    ...
    env = gym.wrappers.Monitor(env,directory=experiment_dir, force=True)
